...
\begin{center}
	{\href{https://linkedin.com/in/luis-miguel-casañ-1b4a05207}{ \sffamily\Huge Luis Miguel Casañ González}}
...
\jobentry
	{from Apr 2021 - Dec 2023} % Duration
	{PT} % FT/PT (full time or part time)
	{} % Employer
	{\href{https://www.cent.uo.edu.cu/cbm/483-2/}{Serious Game Development}} % Job title
	{I collaborated as part of my extracurricular student work with the development team at the Medical Biophysics Center of Santiago de Cuba. Contributed to the design and implementation of a serious game application. Utilized the Unity3D engine to create the entire game environment and harnessed the functionalities offered by the .NET platform to develop a seamless API, facilitating communication between different components of the system. This experience enhanced my skills in game development, software engineering, and teamwork.}
...
% \jobentry
% 	{Current, from Jan 2024} % Duration
% 	{PT} % FT/PT (full time or part time)
% 	{}
...
\begin{supertabular}{r l} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{}{Javascript.}{}
	%------------------------------------------------
	\tableentry{Development Tools}{Flask, FastAPI, .Net,}{}
	\tableentry{}{Unity3D, TensorFlow,}{}
	\tableentry{}{Pytorch, Octave, Git,}{}
	\tableentry{}{Docker.}{}
